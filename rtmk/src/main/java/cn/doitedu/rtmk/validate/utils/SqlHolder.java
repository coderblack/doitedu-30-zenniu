...
public class SqlHolder {
    ...
    public static final String DORIS_EVENTS_DETAIL_SINK_DML
            ...
            "  date_format(to_timestamp_ltz(`timeStamp`,3),'yyyy-MM-dd') as dw_date          ,\n" +
            "  releaseChannel   ,\n" +
            "  account          ,\n" +
            "  appId            ,\n" +
            "  appVersion       ,\n" +
            ...
            "  sessionId        ,\n" +
            "  properties        \n" +
            "FROM kafka_mall_events"   ;


    public static final String KAFKA_EVENTS_SOURCE_DDL
            = " CREATE TABLE kafka_mall_events (                       "
          +       "  testGuid               BIGINT ,                   "
          +       "  eventId                String ,                   "
          +       "  `timeStamp`            BIGINT ,                   "
          +       "  releaseChannel         String ,                   "
